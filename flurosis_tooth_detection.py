...
def write():
    ...
    if uploaded_file is not None:
        ...
        image.save('./Test_Flurosis.jpg')
        st.image(image, caption='Uploaded Image.', use_column_width=True)
        st.write("")
        os.system("python detect.py --weights ./weights/best_flurosis.pt --img 416 --conf 0.5 --source ./Test_Flurosis.jpg")
        image_pred = PIL.Image.open('./inference/output/Test_Flurosis.jpg')
